...
public class ArrayIndexedCollectionTest implements CollectionTest{
    ...
    private ArrayIndexedCollection<String> array;
    private ArrayIndexedCollection<String> emptyArray;

    @Override
    public ArrayIndexedCollection<String> generateEmptyStringCollection() {
        return new ArrayIndexedCollection<>();
    }

    @BeforeEach
    public void init(){
        array = generateEmptyStringCollection();
        array.add("Value0");
        array.add("Value1");
        array.add("Value2");

        emptyArray = generateEmptyStringCollection();
    }
    ...
    public void testCreateArrayWithOtherCollection(){
        ...
        ArrayIndexedCollection<String> collection = new ArrayIndexedCollection<>(other);
    ...
    public void testCreateArrayWithOtherCollectionAndLargeInitialCapacity(){
        ArrayIndexedCollection<String> other = array;
        ArrayIndexedCollection<String> collection = new ArrayIndexedCollection<>(other, 16);
    ...
    public void testCreateArrayWithOtherCollectionAndSmallInitialCapacity(){
        ...
        ArrayIndexedCollection<String> collection = new ArrayIndexedCollection<>(other, 1);
    ...
    public void testAddOrder() {
        ArrayIndexedCollection<String> array = emptyArray;
